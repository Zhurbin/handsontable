describe('NestedHeaders', function () {
  ...
  describe('The \'colspan\' property', function () {
    ...
    it('should allow creating a more complex nested setup', function () {
      ...
      var firstLevel = nonHiddenTHs(hot, 0);
      var secondLevel = nonHiddenTHs(hot, 1);
    ...
    it('should return a relevant nested header element in hot.getCell', function () {
      var hot = handsontable({
      ...
      var allTHs = function allTHs(row) {
        var headerRows = hot.view.wt.wtTable.THEAD.querySelectorAll('tr');
        return headerRows[row].querySelectorAll('th');
      };

      var levels = [nonHiddenTHs(hot, 0), nonHiddenTHs(hot, 1), nonHiddenTHs(hot, 2), nonHiddenTHs(hot, 3)];
    ...
    it('should render the setup properly after the table being scrolled', function () {
      ...
      var levels = [nonHiddenTHs(hot, 0), nonHiddenTHs(hot, 1), nonHiddenTHs(hot, 2), nonHiddenTHs(hot, 3)]; // not scrolled
      ...
      hot.render();
      levels = [nonHiddenTHs(hot, 0), nonHiddenTHs(hot, 1), nonHiddenTHs(hot, 2), nonHiddenTHs(hot, 3)]; // scrolled
